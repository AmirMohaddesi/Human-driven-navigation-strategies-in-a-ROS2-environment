#!/usr/bin/env python3
"""
Smoke-test execute_team_named_mission_specs against a live stack.

Prerequisites: workspace sourced; mission_bridge_node + multi-robot stack running.

  python3 scripts/validate_coordinator_execute_batch_ros.py
"""
...
from multi_robot_mission_stack.coordinator import execute_team_named_mission_specs  # noqa: E402
...
def main() -> int:
    ...
    blob = execute_team_named_mission_specs(specs)
