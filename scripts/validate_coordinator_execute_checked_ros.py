#!/usr/bin/env python3
"""
Smoke-test execute_team_named_mission_spec_checked against a live stack.
...
from multi_robot_mission_stack.coordinator import execute_team_named_mission_spec_checked  # noqa: E402
...
def main() -> int:
    ...
    blob = execute_team_named_mission_spec_checked(spec)
