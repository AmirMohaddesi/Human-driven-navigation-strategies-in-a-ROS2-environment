#!/usr/bin/env python3
"""
Smoke-test execute_team_named_mission_specs_checked against a live stack.
...
from multi_robot_mission_stack.coordinator import execute_team_named_mission_specs_checked  # noqa: E402
...
def main() -> int:
    ...
    blob = execute_team_named_mission_specs_checked(specs)
