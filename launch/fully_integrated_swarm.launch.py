...
def generate_launch_description():
    ...
    nav2_yaml_file1 = os.path.join(
        disaster_pkg_dir,
        'config',
        'nav2_multirobot_params_1.yaml'
    )
    
    nav2_yaml_file2 = os.path.join(
        disaster_pkg_dir,
        'config',
    ...
    # print("urdf_file_path : {}".format(robot1_params))
    ...
    static_transform_publisher_6 = Node(
        package='tf2_ros',
        executable='static_transform_publisher',
        name='static_transform_publisher_6',
        namespace='robot2_ns',
        output='screen',
        parameters=[{
            'use_sim_time': use_sim_time
    ...
    static_transform_publisher_7 = Node(
        package='tf2_ros',
        executable='static_transform_publisher',
        name='static_transform_publisher_7',
        namespace='robot2_ns',
        output='screen',
        parameters=[{
            'use_sim_time': use_sim_time
    ...
    static_transform_publisher_8 = Node(
        package='tf2_ros',
        executable='static_transform_publisher',
        name='static_transform_publisher_8',
        namespace='robot2_ns',
        output='screen',
        parameters=[{
            'use_sim_time': use_sim_time
    ...
    robot1_rviz = IncludeLaunchDescription(
    ...
    robot2_rviz = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(nav2_bringup_dir, 'launch', 'rviz_launch.py')),
        launch_arguments={
            'namespace': 'robot2_ns',
